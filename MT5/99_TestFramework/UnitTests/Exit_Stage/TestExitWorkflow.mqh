...
public:
    static bool Run() {
        ...
        //--------------------------------------------------------------
        {
            ...
            terminal.InjectMockAsset(true, 80001, "TEST-EXIT-A", "GOLD#", 1001, CX_DIR_BUY, 0.1, 2350.00, 0, 0);
        ...
        //--------------------------------------------------------------
        {
            ...
            terminal.InjectMockAsset(true, 80002, "TEST-EXIT-B", "GOLD#", 1001, CX_DIR_BUY, 0.1, 2350.00, 0, 0);
            assetMgr.SetPositionExists(true);
